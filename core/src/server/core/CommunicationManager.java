...
import server.core.db.tables.TableClient;
import server.core.db.tables.TableDictionary;
import server.core.db.tables.TableLogin;
...
public class CommunicationManager
{
	...
	public CommunicationManager(String dbEnvironment)
	{
		this.database = new DataBase(dbEnvironment);
	}
